...
public class MainView extends BorderPane {
  ...
  private Button lineButton, rectangleButton, squareButton, circleButton, triangleButton, ellipseButton, freehandButton, clearButton;
  ...
  public MainView(MainModel model) {
    ...
    buttonsPanel.getChildren().addAll(lineButton, rectangleButton, squareButton, circleButton, triangleButton, ellipseButton, freehandButton, clearButton);
